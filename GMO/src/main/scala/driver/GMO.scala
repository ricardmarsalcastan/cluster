...
/**************************************************************************
    ...
    */
     ...
     ********************************************************************************/
    val gmo = new GMOModel(trainingData, testingData, numForests, numTrees, numClasses, featureSubsetStrategy, impurity, maxDepth, maxBins,generations) 
